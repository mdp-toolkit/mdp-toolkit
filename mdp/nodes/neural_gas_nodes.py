...
class _NGNodeData(object):
    ...
    def __init__(self, pos, error=0.0, hits=0, label=None):
        """Initializes an object of type '_NGNodeData'.
...
class _NGEdgeData(object):
    ...
    def __init__(self, age=0):
        """Initializes an object of type '_NGEdgeData'.
...
class GrowingNeuralGasNode(Node):
    ...
    def _move_node(self, node, x, eps):
        ...
        :param x: The point to move in the direction of.
        :type x: numpy.ndarray
        
        :param eps: The distance to move.
        :type eps: float
        """
    ...
    def _remove_old_edges(self, edges):
        ...
        :param edges: Candidates that are considered to be removed.
        :type edges: 
        """
...
class NeuralGasNode(GrowingNeuralGasNode):
    ...
    def __init__(self, num_nodes = 10,
        ...
        :param num_nodes: Number of nodes to use. Ignored if start_poss is given.
            Default is 10.
        :type num_nodes: int
        ...
        :param start_poss: Sequence of two arrays containing the position of the
            ...
            variance.
            Default is None.
        :type start_poss: list, tuple or numpy.ndarray
        
        :param epsilon_i: Initial value of epsilon. Fraction of the distance
            ...
            being the epoch.
            Default is 0.3.
        :type epsilon_i: float
        
        :param epsilon_f: Final value of epsilon. Fraction of the distance
            between the closest node and the presented data point by which the
            node moves towards the data point in an adaptation step. Epsilon
            decays during training by e(t) = e_i(e_f/e_i)^(t/t_max) with t
            being the epoch.
            Default is 0.05.
        :type epsilon_f: float
        
        :param lambda_i: Initial value of lambda. Lambda influences how the
        ...
        :param lambda_f: Final value of lambda. Lambda influences how the
            weight change of nodes in the ranking decreases with lower rank. It 
            is sometimes called the "neighborhood factor". Lambda decays during
            training in the same manner as epsilon does.
            Default is 0.01.
        ...
        :param max_age_i: Initial lifetime, after which an edge will be removed.
        ...
        :param max_age_f: Final lifetime, after which an edge will be removed.
            Lifetime is measured in terms of adaptation steps, i.e.,
            presentations of data points. It decays during training like
            epsilon does.
            Default is 200.
        ...
        :param max_epochs: Number of epochs to train. One epoch has passed when all data points
        ...
        :param n_epochs_to_train: Number of epochs to train on each call. Useful for batch learning
            and for visualization of the training process. Default is to
            train once until max_epochs is reached.
        :type n_epochs_to_train: int
